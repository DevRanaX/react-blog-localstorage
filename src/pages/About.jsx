    ...
    <Layout>
      ...
      <div className="flex justify-between flex-col-reverse md:flex-row py-20 px-8">
          <div className="space-y-3 basis-9/12 ">
            ...
            <h3 className="text-4xl font-bold capitalize">hello, i'm <span className='text-green-500'>Rana Abdullah Tahir</span> </h3>
            <p className="text-lg font-semibold">Introducing <span className='text-green-500'>Rana Abdullah Tahir,</span> a skilled React.js developer with a passion for crafting beautiful and functional online experiences. A master of both front-end development and WordPress, Abdur brings a unique blend of technical expertise and creative vision to every project touches.</p>
